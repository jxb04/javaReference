...
public class LambdasAsArgumentsDemo {
	...
	public static void main (String args[]) {
		...
		// that is passes to stringOp().
		outStr = stringOp((str) -> str.toUpperCase(), inStr);
		System.out.println("The string in uppercasse: " + outStr);
		...
		// Of course, it is also possible to pass a StringFunc instance created by
		// an earlier lambda expression.  For example, after this declaration
