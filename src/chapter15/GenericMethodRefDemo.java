...
// This class defines a method called countMatchin() that returns the number of items in an array 
// that are equal to a specified value.  Notice that countMatching() is generic, but MyArrayOps is not.
